...
public class Main {
	public static void main(String[] args) {
		...
		String[] questions = {"Which of the three are in Alice In Chains?", "", "When did Prince's album, Around the World In a Day, come out?", 
				"What os the highest grossing album of all time?", "", "", "When was the band, Sade, formed?", 
